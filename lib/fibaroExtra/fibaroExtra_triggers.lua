...
--  {"date":"08:24 | 9.7.2022","changes":[],"events":[{"objects":[{"objectType":"device","objectId":756}],"type":"DeviceActionRanEvent","created":1657347877,"sourceId":2,"data":{"args":[],"actionName":"turnOn","id":756},"sourceType":"user"}],"last":341112,"status":"IDLE","timestamp":1657347877}
    ...
    --Exported: Register a source trigger callback
    ...
    --Exported: Unregister a source trigger callback
    ...
    --Exported: Enable source triggers
    ...
    --Exported: Disable source triggers
    ...
    --Exported: Register a refresh states callback
    ...
    --Exported: Unregister a refresh states callback
    ...
    --Exported: Enable refresh states
    ...
    --Exported: Post a geofence refresh state
    ...
    --Exported: Post a a centralScene refresh state
